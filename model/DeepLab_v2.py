...
# refer to https://github.com/kazuto1011/deeplab-pytorch/blob/master/libs/models/resnet.py
...
class DeepLab_v2(nn.Sequential):
    """
    ...
    def __init__(self, n_classes, n_blocks, atrous_rates):
        ...
        self.add_module("interpolation",nn.Upsample(scale_factor=8, mode='bilinear', align_corners=True))
